...
3. Web based (Python, Flask, Angular) UI which will demonstrate the usage of the models created
    The web application front end UI will provide input fields for the end user to enter (will include basic data entry validation).
    The input values will be passed on to the model in the back end. The response will be displayed to the user as a result of utilizing the model in the backend.

The production deployment is not included in the current scope.
## Sub Title Example
