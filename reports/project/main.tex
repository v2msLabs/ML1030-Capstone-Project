...
\title{Credit Score Estimator and Lender Evaluation Tool}
\author{by Vadim Spirkov, Murlidhar Loka}

\maketitle

\abstract{%
In the word of financial credit the industry practitioners are topically
...
problem. Before we proceed any further we would like to introduce our
business partner - KASI Insight. KASI Insights is an award-winning and
leading provider of consumer data, measures and insights to understand
average African consumer. Every month, the company listens to Africans
and turns survey based data into actionable insights. Through its
self-service platform, the clients of the firm leverage consumer
...
\begin{itemize}
\item
  Credit Score Estimator model
\item
  Lender Evaluator model
\end{itemize}
