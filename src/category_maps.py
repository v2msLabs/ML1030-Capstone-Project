...
map_col11 = {'18-24': 2, '25-29': 3, '40-44': 6, '35-39': 5, '30-34': 4, '45-54': 7, '55-64': 8,
             'less than 17 years': 1, '65+': 9, '45+': 7, '-17': 1, '35 - 44': 5, '18 - 24': 2,
             '25 - 34': 3, '45 - 54': 7, '55 +': 8}
map_col12 = {'High school, no diploma / BEPC': 2, 'Bachelor’s degree / Licence': 5,
...
map_col13 = {'Salaried employee / Salarié': 2, 'Unemployed / Sans emploi': 5,
             ...
             'ferronnier': 2}
map_col14 = {'Technical or Other college diploma / Collège technique': 1,
...
map_col18 = {'Between 2-3 times': 2, 'Once': 3, 'More than 4 times': 1, 'Never': 4,
             ...
             'Jamais, Une fois': 4}
map_col20 = {'Business colleagues': 3, 'Friends': 2, 'Family': 1,
...
map_col21 = {'At least 3 months but less than 6 months': 3,
...
map_col22_23_24 = {'About half the time': 3, 'Occasionally': 4, 'Most of the time': 2, 'Never': 5,
...
map_col25 = {'At least 5-6 out of 10 times': 4, 'At least 7-8 out of 10 times': 3,
...
map_col26 = {'To invest or cover business expenses (Merchandise, salaries, etc..)': 3,
...
map_col30_31_32 = {'4': 4, '2': 2, '3': 3, '5 - Definitely agree': 5, '1 - Definitely disagree': 1,
                   '5 - Complètement en accord': 5, '1 - Complètement en désaccord': 1}
map_col33 = {'Student loan': 1, 'Mobile loan': 2, 'Bank loan': 3, 'Private loan': 4,
...
map_col36 = {'Less than 5%': 1, '5% -10%': 2, '10% - 20%': 3, '20% - 30%': 4,
             '30% - 40%': 5, '40% - 50%': 6,
